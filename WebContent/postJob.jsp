					...
					<div class="box-body">
						<div class="form-group">
							...
							<div class="row col-md-12">
								...
								<div class="col-md-4">
									<label>Experience</label> <select class="form-control select2" name="experience">
										<option>Select</option>
							...
							<div class="col-md-12">
								...
								<div class="col-md-4">
									<a href="stuJob.jsp">
										<button type="button" class="btn btn-block btn-primary btn-lg">Close</button>
									</a>
								</div>

								<div class="col-md-4">
									<button type="submit" class="btn btn-block btn-primary btn-lg">Apply</button>
								</div>
							</div>
						</div>
						<!-- form-froup -->
